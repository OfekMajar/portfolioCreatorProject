...
function singleResume() {
  ...
  return (
    <div id='singleResumeContainer'>   
        {singleResume?  <Template1 isPreview={false} workExp={singleResume.userWorkExp} educations={singleResume.educations} contactInfo={singleResume.userContactInfo} />:null}
     
     <button onClick={downloadPDF}
     disabled={!(loader===false)}>  {loader?(
